...
* ~ようになっている：可以
* なければならない：必须，不得不
* とめる(tomeru) 主要用于谈论已经“停止”并可能再次重新启动的事物。这有这个词更多地用于非人类事物的含义。它通常与机器、交通工具，甚至动物一起使用——说话者无法控制的东西，因此，任何停止的事情都有可能再次重新启动。另一方面，やめる(yameru) 仍然表示“停止”，但更倾向于“退出”“结束”。这主要用于人。这就是为什么当你在看动画时，可能会看到两个男主为了争夺某个事物而大打出手，此时就会有他们的同伴在旁边大喊“やめて！”而不是“とめて！” 。
* 預ける：站在委托人立场，让人（保管、存放、照顾）某物。預かる：站在被委托人立场，帮某人（代保管、代存放、代照顾）某物。
  * 基本句型为：
  * 1.AはBにCを預ける。
  * 2.BはAからCを預かる
  * 1.娘は母に子供を預けました。
...
* 「が」表示未知（新的信息）；「は」表示已知（旧的信息）。
  * 姉が帰りました。（姐姐回来了。）
  * 这句话中，‘回来了’是已知的信息。但是不知道是‘谁’回来了。是「誰が帰りましたか。」（谁回来了？）这个问题的回答。与之相反：
  * 姉は帰りました。（姐姐回来了。）
...
する，以及所有带有する的动词。
通常是外来语以及两个汉字添加する构成的动词

### 一段动词

一定以る结尾，并且倒数第二个假名在い或者え段
也就是iru或者eru结尾的


### 五段动词

如果不是以る结尾，那就一定是五段动词，但是也有例外，如はじまる(始まる)。
但当る之前只有一个假名的时候，或者e和i位于汉字内部时，尽管这些词符合一段动词的特征，但是通常都会被分为五段动词（少部分不服从这两个特殊规则的特例只能死记硬背）。
...
形容词分为一类形容词、二类形容词，一类形容词直接加名词，二类形容词通常长得很像名词，但是连用名词时需要加“な”
